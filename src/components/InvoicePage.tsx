      ...
      <Page className="invoice-wrapper" pdfMode={pdfMode}>
        ...
        <View className="flex" pdfMode={pdfMode}>
          <View className="w-50" pdfMode={pdfMode}>
            ...
            <EditableInput
              placeholder="Pan No."
              value={invoice.companyAddress}
              onChange={(value) => handleChange('companyPanNO', value)}
              pdfMode={pdfMode}
            />
            <EditableInput
              placeholder="GST No."
              value={invoice.companyAddress}
              onChange={(value) => handleChange('companyGstNo', value)}
              pdfMode={pdfMode}
            />
          </View>
          <View className="w-50" pdfMode={pdfMode}>
          ...
          <View className="w-55" pdfMode={pdfMode}>
            ...
            />
             <EditableInput
              ...
              value={invoice.clientName}
              onChange={(value) => handleChange('palcesuppy', value)}
              pdfMode={pdfMode}
            />
             <EditableInput
              placeholder="Place of Deliver"
              value={invoice.clientName}
              onChange={(value) => handleChange('placedeliver', value)}
              pdfMode={pdfMode}
            />
        ...
        <View className="mt-20" pdfMode={pdfMode}>
          <EditableInput
            ...
            onChange={(value) => handleChange('sign', value)}
            pdfMode={pdfMode}
          />
